...
router.get("/api/Adviser-InProject/:projectId",userController.adviserInProject);  //muestra los asesores dependiendo el id_project   (correcto)


router.post("/api/register-users", userController.registerUsers); // procedimiento para registrar alumnos nuevos                   (correcto)
